...
ALTER TABLE "FlightSpecs" ADD COLUMN "AscentRateFeetPerMinute" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "FlightSpecs" ADD COLUMN "DescentRateFeetPerMinute" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "FlightSpecs" ADD COLUMN "FinalApproachSpeed" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "FlightSpecs" ADD COLUMN "DescentVerticalSpeed" INTEGER NOT NULL DEFAULT 0;
*/
