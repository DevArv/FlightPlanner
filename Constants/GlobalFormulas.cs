...
public static class GlobalFormulas
{
    ...
    public static int EMBRAER_E190_HA_RESERVE_FUEL = 1500;
    public static int EMBRAER_E190_HA_EMERGENCY_FUEL = 1200;
    
    public static int EMBRAER_E190_MA_AVERAGE_FUEL = 7000;
    public static int EMBRAER_E190_MA_RESERVE_FUEL = 1000;
    public static int EMBRAER_E190_MA_EMERGENCY_FUEL = 800;
    
    public static int EMBRAER_E190_LA_AVERAGE_FUEL = 4000;
    public static int EMBRAER_E190_LA_RESERVE_FUEL = 600;
    public static int EMBRAER_E190_LA_EMERGENCY_FUEL = 400;
    
    //EMBRAER E190 - CRUISE ALTITUDE
    public static int EMBRAER_E190_HA_CRUISE_ALTITUDE = 37000;
    public static int EMBRAER_E190_MA_CRUISE_ALTITUDE = 31000;
    public static int EMBRAER_E190_LA_CRUISE_ALTITUDE = 25000;
    
    //EMBRAER E190 - CRUISE SPEED
    public static int EMBRAER_E190_HA_CRUISE_SPEED = 470;
    public static int EMBRAER_E190_MA_CRUISE_SPEED = 450;
    public static int EMBRAER_E190_LA_CRUISE_SPEED = 430;
}